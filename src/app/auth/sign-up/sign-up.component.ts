...
export class SignUpComponent implements OnInit {
  ...
  getErrorMessageForPassword() {
    if (this.form.get('password').hasError('required')) {
      ...
      return `password should be more or equal then ${
      ...
      return `password should be less or equal then ${
        this.form.get('password').errors.maxlength.requiredLength
      } you enter ${
        this.form.get('password').errors.maxlength.actualLength
      } symbol`;
    }
    return 'unknown';
  }
